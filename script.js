...
function sendMessage() {
  ...
  setTimeout(() => {
   ...
   else if (msg.includes("hire me") || msg.includes("pricing") || msg.includes("work") || msg.includes("hire")) {
  reply = `
  ...
  `;
    ...
    else if (msg.includes("recruiter") || msg.includes("resume") || msg.includes("job")) {
      reply = `
